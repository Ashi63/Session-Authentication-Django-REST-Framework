...
SECRET_KEY = 'django-insecure-1-1l14asqpu#-vas(h*wy*f9sgv^)8c)r@9^&w881#79xdm!e3'
...
SITE_DOMAIN = "http://localhost:8000"   # website domain name
SITE_NAME = "Local Host"                # website name
...
# Session expiry time default is 1209600 sec = 14 days
