...
from account.views import RegistrationView,ActivateView,ActivationConfirm,GetCSRFToken,LoginView,UserDetailView,ChangePasswordView,DeleteAccountView,LogoutView,ResetPasswordEmailView,ResetPasswordView,ResetPasswordConfirmView,CheckAuthenticatedView
urlpatterns = [
